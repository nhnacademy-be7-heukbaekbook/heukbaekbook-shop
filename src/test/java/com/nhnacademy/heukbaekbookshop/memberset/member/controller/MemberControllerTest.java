...
//
//import static com.nhnacademy.heukbaekbookshop.memberset.member.domain.MemberStatus.ACTIVE;
...
//
//    @Test
//    void testGetMyPageResponse() throws Exception {
//        // Mock DeliverySummaryResponse 생성
//        DeliverySummaryResponse mockDeliverySummaryResponse = new DeliverySummaryResponse();
//
//        // Mock OrderSummaryResponse 리스트 생성
//        List<OrderSummaryResponse> mockOrderSummaryResponses = List.of(
//                new OrderSummaryResponse(
//                        "2024-11-25T12:00:00",
//                        "TOSS123456789",
//                        "Java Programming",
//                        "DELIVERED",
//                        mockDeliverySummaryResponse
//                ),
//                new OrderSummaryResponse(
//                        "2024-11-20T15:00:00",
//                        "TOSS987654321",
...
//        );
//
//        // Mock OrderResponse 생성
//        OrderResponse mockOrderResponse = new OrderResponse(mockOrderSummaryResponses);
//
//        // Mock MemberResponse 생성
...
//        );
//
//        // Mock MyPageResponse 생성
//        MyPageResponse mockMyPageResponse = new MyPageResponse(mockMemberResponse, mockOrderResponse);
//
//        // Mock 서비스 동작 설정
//        when(memberService.getMyPageResponse(anyLong())).thenReturn(mockMyPageResponse);
//
//        // 테스트 수행
//        mockMvc.perform(get("/api/members/my-page")
//                        .header(MemberController.X_USER_ID, 1L))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.memberResponse.name").value("홍길동"))
//                .andExpect(jsonPath("$.memberResponse.phoneNumber").value("010-1234-5678"))
//                .andExpect(jsonPath("$.memberResponse.email").value("test@example.com"))
//                .andExpect(jsonPath("$.memberResponse.loginId").value("testuser"))
//                .andExpect(jsonPath("$.memberResponse.memberStatus").value("ACTIVE"))
//                .andExpect(jsonPath("$.memberResponse.grade.gradeName").value("Gold"))
//                .andExpect(jsonPath("$.memberResponse.grade.pointPercentage").value("0.1"))
//                .andExpect(jsonPath("$.memberResponse.grade.promotionStandard").value("1000.0"))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList.size()").value(2))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList[0].tossOrderId").value("TOSS123456789"))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList[0].title").value("Java Programming"))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList[0].status").value("DELIVERED"))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList[1].tossOrderId").value("TOSS987654321"))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList[1].title").value("Spring Framework"))
//                .andExpect(jsonPath("$.orderResponse.orderSummaryResponseList[1].status").value("SHIPPED"));
//    }
//
//}
