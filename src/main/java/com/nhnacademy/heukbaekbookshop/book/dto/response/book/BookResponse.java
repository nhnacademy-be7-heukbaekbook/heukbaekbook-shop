...
public record BookResponse(Long id, String title, String publishedAt, String salePrice, double discountRate, String thumbnailUrl, List<ContributorSummaryResponse> contributors, PublisherSummaryResponse publisher) {
}
